...
import { updateCommandsForAllGuildsWithoutClient } from './command-handling/update-commands.js';
...
try {
	...
	await updateCommandsForAllGuildsWithoutClient(config.token, config.clientId);
