...
import { MessageMetadata, MessageType } from './record-types.js';
...
let getMessageMetadataStatement: Statement = null;
let fetchRPMessageMetadataStatement: Statement = null;
let addMessageMetadataStatement: Statement = null;
let deleteMessageMetadataStatement: Statement = null;
let deleteOutdatedMessageMetadataStatement: Statement = null;
 ...
 */
export function getMessageMetadata(messageId: string, logger: Logger): MessageMetadata | null {
	try {
 ...
 * this is handled and null is returned.
 */
export function findNewestRPMessageMetadata(
 ...
 */
export function deleteMessageMetadata(messageId: string) {
